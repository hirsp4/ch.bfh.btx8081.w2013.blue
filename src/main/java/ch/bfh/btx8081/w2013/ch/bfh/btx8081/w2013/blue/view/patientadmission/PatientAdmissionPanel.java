package ch.bfh.btx8081.w2013.ch.bfh.btx8081.w2013.blue.view.patientadmission;
...
public class PatientAdmissionPanel extends BorderPanel {
	...
	private ListSelect createListPatientAboutList() {
		...
		this.patientAboutList.setImmediate(true);
		...
		patientAboutList.addValueChangeListener(new ValueChangeListener() {
			private static final long serialVersionUID = 1L;
